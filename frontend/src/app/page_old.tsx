        ...
        <main className="container mx-auto px-6 py-20">
          ...
          <div className="text-center bg-gradient-primary rounded-3xl p-20 shadow-large">
            ...
            <p className="text-primary-100 mb-12 max-w-3xl mx-auto text-xl leading-relaxed font-medium">
              Join thousands who trust Cyberlex for reliable legal guidance and expert insights.
            </p>
            <Link 
              href="/auth/signup" 
          ...
          <div className="container mx-auto px-6 py-12">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg font-semibold text-primary-800">Cyberlex</span>
              </div>
              ...
              <p className="text-primary-700">© 2025 Cyberlex Assistant</p>
            </div>
          </div>
        </footer>
      </div>
